      ...
      <div className='grid gap-4 md:grid-cols-2'>
        <Card>
          ...
          <CardContent>
            ...
            <Link className='text-sm text-primary hover:underline' href={`/org/${org.slug}/members`}>
              View all members
            </Link>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Link className='text-sm text-primary hover:underline' href={`/org/${org.slug}/projects`}>
              View all projects
            </Link>
          </CardContent>
        </Card>
